...
/**
 * Zod schema for skill model
 */
export const SkillModelSchema = z
	.object({
		// Add fields when data structure is known
	})
	.passthrough(); // Allow unknown fields until specific schema is defined

/**
 * Zod schema for stat model
 */
export const StatModelSchema = z
	.object({
		// Add fields when data structure is known
	})
	.passthrough(); // Allow unknown fields until specific schema is defined
...
export const ItemProductSchema = z.object({
	...
	skillModels: z.array(SkillModelSchema),
	statModels: z.array(StatModelSchema),
