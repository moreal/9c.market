    ...
    <nav class="bg-gradient-to-r from-sky-800 to-indigo-900 shadow-lg">
      <div class="container mx-auto flex items-center p-4 text-gray-200">
        <div class="flex items-center mr-6">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-sky-400 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <ul class="flex items-center">
          ...
          <li class={`border-b-2 ${active("/iap")} mx-3 py-2`}>
            <a href="/iap" class="flex items-center transition-colors duration-200">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" />
              </svg>
              IAP Products
          ...
          <li class={`border-b-2 ${active("/about")} mx-3 py-2`}>
            <a href="/about" class="flex items-center transition-colors duration-200">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
