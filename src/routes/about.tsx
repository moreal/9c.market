		...
		<main class="container mx-auto px-4 py-8 max-w-6xl">
			<PageHeader title="About Nine Chronicles Market">
				<p class="text-lg opacity-90 max-w-3xl mx-auto text-white leading-relaxed">
					Discover the story behind the Nine Chronicles marketplace and how
					we're making it easier to enhance your gaming experience.
				</p>
			</PageHeader>
			...
			<div class="bg-white rounded-lg shadow-md p-6 md:p-8 mb-8">
				<div class="max-w-3xl mx-auto">
					...
					<p class="text-gray-700 leading-relaxed mb-6">
						Nine Chronicles Market was created to provide a seamless interface
						for players to browse and purchase in-game items, resources, and
						bonuses. Our platform integrates directly with the Nine Chronicles
						game ecosystem, ensuring secure and instant delivery of all
						purchased items.
					</p>
					...
					<ol class="list-decimal list-inside space-y-3 text-gray-700 mb-6">
						<li>
							Browse our extensive collection of in-game items and resources
						</li>
					...
					<p class="text-gray-700 leading-relaxed mb-4">
						Our marketplace is built using modern web technologies to ensure a
						fast, secure, and responsive experience:
					</p>
